-- Add city_name and country columns to airports table
...
-- Update the search_airports function to include the new fields
...
-- Update the get_city_airports function to include country
...
-- Update the get_airport_by_code function to include country

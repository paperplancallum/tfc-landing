...
interface DealDigestPremiumEmailProps {
  edition: string;
  dealsList: Deal[];
                  ...
                  <td width="60%" style={dealContent}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '60px', marginTop: '8px' }}>
                      <Text style={dealPrice}>
                        {deal.currency === 'GBP' ? '£' : '€'}{(parseFloat(deal.price) / 100).toFixed(2)}
                      </Text>
                      <Button
...
export default DealDigestPremiumEmail;